...
public class EventPostTest {
    ...
    @Rule
    public ActivityScenarioRule<PostEvent> activityScenarioRule
            = new ActivityScenarioRule<>(PostEvent.class);
    ...
    public void testEventPost() throws InterruptedException {
        ...
        onView(withId(R.id.title))
                .perform(typeText("Event User Test"), closeSoftKeyboard());
        ...
        DatabaseReference reference = FirebaseDatabase.getInstance("https://treehole-database-default-rtdb.firebaseio.com/").getReference("posts").child("event").child(timestamp);
