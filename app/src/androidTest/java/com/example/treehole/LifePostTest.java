...
public class LifePostTest {
    ...
    @Test
    public void testLifePost() throws InterruptedException {
        //set user

        onView(withId(R.id.title))
                .perform(typeText("Life User Test"), closeSoftKeyboard());
        ...
        DatabaseReference reference = FirebaseDatabase.getInstance("https://treehole-database-default-rtdb.firebaseio.com/").getReference("posts").child("life").child(timestamp);
